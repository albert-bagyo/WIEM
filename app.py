...
def generate_description(weather,location):
    ...
    param = { 'temperature' : weather['main']['temp'] - 273,
    ...
    templates = [
        ...
        "Today in {location}, you can expect a temperature of {temperature:.1f}°C, but it feels more like {feels_like:.1f}°C thanks to {humidity}% humidity. The weather is mostly cloudy with {clouds}% cloud cover. Visibility extends up to {visibility / 1000:.1f} kilometers, and winds are blowing at {wind_speed:.1f} meters per second, gusting up to {wind_gust:.1f} meters per second from {wind_dir}°. The sun rose at {sunrise_str} UTC and will set at {sunset_str} UTC.",
        ...
        "The current weather in {location} shows a temperature of {temperature:.1f}°C, feeling like {feels_like:.1f}°C due to {humidity}% humidity. Cloud cover is extensive at {clouds}%, with visibility extending up to {visibility / 1000:.1f} km. Winds are blowing at a speed of {wind_speed:.1f} m/s, gusting up to {wind_gust:.1f} m/s from {wind_dir}°. The sun rose at {sunrise_str} UTC and will set at {sunset_str} UTC.",
